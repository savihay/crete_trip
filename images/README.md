...
כל יעד טוען קובץ תמונה לפי הנתיב שמוגדר ב-`index.html`, ואם הוא חסר נטען `images/<id>.svg` כ-placeholder.

⚠️ **הסיומת חייבת להתאים.** אם מעלים `knossos.webp` במקום `knossos.jpg` — צריך לעדכן את הנתיב ב-`index.html`.
הכי פשוט: לשמור בדיוק בשם ובסיומת שכבר מופיעים שם.
